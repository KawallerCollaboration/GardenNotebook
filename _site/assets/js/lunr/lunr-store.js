var store = [{
        ...
        "excerpt":"This is my first modification def print_hi(name) puts \"Hi, #{name}\" end print_hi('Tom') #=&gt; prints 'Hi, Tom' to STDOUT. Horse sense is the thing a horse has which keeps it from betting on people. W. C. Fields Notices: Changes in Service: This website will not be available till later in the...","categories": ["blog"],
